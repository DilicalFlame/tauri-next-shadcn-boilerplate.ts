...
export default defineConfig({
  ...
  themeConfig: {
      ...
      '/manual/': [
        {
          ...
          items: [
            ...
            { text: 'Documentation Guide', link: '/manual/06-documentation-guide' },
      ...
      '/api/': [
        {
          ...
          items: [
            ...
            { text: 'Logger', link: '/api/lib/services/Logger/classes/LoggerService' },
            { text: 'TauriService', link: '/api/lib/services/TauriService/classes/TauriService' },
            { text: 'WindowManager', link: '/api/lib/services/WindowManager/classes/WindowManager' }
          ]
        }
      ]
    },
    ...
    socialLinks: [
      { icon: 'github', link: 'https://github.com/DilicalFlame/tauri-next-shadcn-boilerplate.ts' }
    ],
